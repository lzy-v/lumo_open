...
//
// This is a complete version of the NonFungible contract
...
pub contract NonFungible {
    ...
    pub resource Collection: NFTReceiver {
        ...
        pub fun withdraw(withdrawID: UInt64): @NFT {
            ...
            let token <- self.ownedNFTs.remove(key: withdrawID) ?? panic("no such id found")
            return <-token
        }
	...
	init() {
        ...
        // note we do not publish any API here
